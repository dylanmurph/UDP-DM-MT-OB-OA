...
def create_app():
    ...
    # Allow requests from the front-end (React app)
    ...
    with app.app_context():
        ...
        try:
            ...
            first_user = User.query.first()  # Try to get the first user from the User table
            print(f"First User: {first_user}")
            
        except Exception as e:
            print(f"Error creating tables: {e}")  # Print any error if table creation fails
